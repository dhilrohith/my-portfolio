const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/in/dhil-rohith-b-427a3b222/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/__.dhil.__/',
  ...
  return (
    ...
    >
        ...
        lg:items-stretch">
            ...
            <div 
            className="mb-12 lg:mb-0 lg:flex
            lg:flex-col"
            >
                <h2 
                className="headline-2
                lg:max-w-[12ch] reveal-up"
                >
                ...
                mt-3 mb-8 max-w-[50ch]
                lg:max-w-[30ch] reveal-up"
                >
                    Reach out today to discuss your project needs and start working on something amazing!
                </p>
                ...
                >
                    {socialLinks.map(({
                        ...
                        href={href}
                        target="_blank"
                        className="w-12 h-12 grid place-items-center inset-ring-2 inset-ring-zinc-50/5 rounded-lg transition-[background-color,color]
                        hover:bg-zinc-50
                        hover:text-zinc-950
            ...
            <form 
            // getform.io
            action="https://getform.io/f/bdrnkjdb"
            method="POST" 
            ...
            >
                ...
                >
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email" 
                        required
                        placeholder="robbinhood123@gmail.com"
                        className="text-field reveal-up" 
                        />
                    </div>
                </div>
